...
async def sbs_info(user, password, step, istel):
    ...
    if login_token == 0:
        ...
        if app_token == 0:
            ...
            data = f'userid={userid}&last_sync_data_time=1597306380&device_type=0&last_deviceid=DA932FFFFE8818E8&data_json={data_json}'
            try:
